"""
Django settings for agriwise_backend project.
...
SECRET_KEY = 'django-insecure-(s5d-2z#6$&3w*t4n9u2&650du%o@iv!6e*9zm54j9jr&wysi7'
...
ROOT_URLCONF = 'agriwise_backend.urls'
...
WSGI_APPLICATION = 'agriwise_backend.wsgi.application'
